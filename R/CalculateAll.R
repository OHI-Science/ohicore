...
#'   \item regional likely future for supragoals - calculate regional likely future score for supragoals as average of subgoals.
...
CalculateAll = function(conf, layers, debug=F){
  ...
  browser('TODO: confirm supragoals selected and subgoal data OK.')
