...
##' }
##' 
##' @export CalculateResilienceScore CalculateResilienceMatrix
CalculateResilienceScore <- function(r, t, w=NA, gamma=0.5, resilience_categories=c('environmental', 'regulatory', 'social')) {
...
CalculateResilienceMatrix <- function(b, w.layers=NA) {
