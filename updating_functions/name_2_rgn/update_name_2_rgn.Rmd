...
This script can be used to update the synonyms in name_2\_rgn as well as confirm that the update was successful.
...
new_synonyms <- c("Micronesia Federated States of")
