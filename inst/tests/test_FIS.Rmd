...
Warning messages:
1: In CheckLayers(layers.csv, dir.to, flds_id = c("rgn_id", "cntry_key",  :
  Missing fields...
    snk_fis_meancatch: NA metric.tons
    snk_fis_proparea_saup2rgn: NA proparea
2: In CheckLayers(layers.csv, dir.to, flds_id = c("rgn_id", "cntry_key",  :
  Unused fields...
    snk_fis_meancatch: TaxonName_TaxonKey,MeanCatch
    fnk_fis_b_bmsy: TaxonName
    snk_fis_proparea_saup2rgn: propArea
3: In CheckLayers(layers.csv, dir.to, flds_id = c("rgn_id", "cntry_key",  :
  Rows duplicated...
    snk_fis_meancatch: 142417
    fnk_fis_b_bmsy: 76558
...
# NOTE: these differences are due to 4_yr species only previously getting trend calculated to 4 years (instead of 5)
```